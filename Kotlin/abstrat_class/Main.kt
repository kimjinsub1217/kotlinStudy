package com.example.kotlinstudy.Kotlin.abstrat_class
...
//학원 직원 클래스. initial은 초봉(반기), years는 경력(년)
...
fun main(args:Array<String>){
    val finance= getFinance(Student(300),Student(330)
        ,Professor(1),Professor(2),Employee(1300,2)
    )
    println("학원 재정:${finance} 만원")
}